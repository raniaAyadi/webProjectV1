        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                $maison=$decorMaisonManager->getMaison($maisonId);
                 ...
                 ?>
                <!--title-->
                <h1><?php echo $maison->getTheme()?></h1>

                <!-- Author -->
                <p class="lead">
                    by <a href="#"><?php echo $maison->getNomClient()?></a>
                </p>

                <hr>

                <!-- Date/Time -->
                <p><span class="glyphicon glyphicon-time"></span> Posted on  <?php echo $maison->getDateM() ?></p>
                ...
                <!-- Post Content -->
                <p class="lead">
                    <?php echo $maison->getDescription() ?>
                </p>
                <hr>
                <!-- Blog Comments -->
                ...
                <div class="media">
                    <a class="pull-left" href="#">
                        <img class="media-object" src="images/ident.jpg" alt="">
                    </a>
